        ...
        items(testResults) { item ->
            Card(
               ...
               Row (horizontalArrangement = Arrangement.SpaceBetween) {
                   Text(text = "BW: ${item.bandwidth}", Modifier.weight(1f), fontWeight = FontWeight.Bold, color = Color.Cyan)
                   Text(text = "Trans: ${item.transfer}", Modifier.weight(1f), fontWeight = FontWeight.Bold, color = Color.Green)
